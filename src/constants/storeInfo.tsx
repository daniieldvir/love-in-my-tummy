...
export const infoCards: InfoCardItem[] = [
    ...
    },
    {
        icon: <FaClock />,
        title: 'Opening Hours',
        description: ['Sun – Thu: 8am – 8pm', 'Friday: 8am – 2pm', 'Saturday: Closed'],
    },
];
...
export const faqItems: FaqItem[] = [
    {
        ...
        answer: 'Absolutely! Send us a message with your idea and we\'ll work with you to create something truly special.',
    },
    {
        question: 'Do you offer delivery?',
        answer: 'Yes! We deliver within the Tel Aviv area. Our checkout page includes delivery options with scheduling.',
    },
    {
        question: 'Can I order for events?',
        answer: 'Of course! We love catering for birthdays, weddings, and corporate events. Get in touch to discuss.',
    },
];
